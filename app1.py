...
st.markdown("<h1 style='text-align:left; color:#205080; font-size:2rem; font-weight:900; letter-spacing:2px;'>Aviation Club Dashboard</h1>", unsafe_allow_html=True)
...
with tab1:
    ...
    route_map = folium.Map(location=[(origin_lat+dest_lat)/2, (origin_lon+dest_lon)/2], zoom_start=6, tiles="CartoDB Positron")
